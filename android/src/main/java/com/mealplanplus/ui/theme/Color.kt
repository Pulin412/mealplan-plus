...
val LightAppColors = AppColors(
    ...
    mutedDark    = Color(0xFF4C575F),
    muted        = Color(0xFF636D75),
    mutedLight   = Color(0xFF6E7880),
    mutedFaint   = Color(0xFF78828A),
...
val DarkAppColors = AppColors(
    ...
    // Subtext ramp kept near-white in dark mode — grey secondary text was unreadable.
    mutedDark    = Color(0xFFE0E6E9),
    muted        = Color(0xFFD2DADE),
    mutedLight   = Color(0xFFC3CCD1),
    mutedFaint   = Color(0xFFB4BEC3),
