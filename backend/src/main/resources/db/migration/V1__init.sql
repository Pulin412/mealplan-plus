...
CREATE TABLE foods (
    ...
    brand            VARCHAR(255),
    barcode          VARCHAR(255),
    calories_per100  DOUBLE PRECISION NOT NULL DEFAULT 0,
    protein_per100   DOUBLE PRECISION NOT NULL DEFAULT 0,
    carbs_per100     DOUBLE PRECISION NOT NULL DEFAULT 0,
    fat_per100       DOUBLE PRECISION NOT NULL DEFAULT 0,
