# webapp/ — MealPlan+ Web PWA

Next.js 14 + TypeScript + Tailwind app (the canonical PWA; the old pre-redesign webapp was removed).
...
2. Commit / push only when explicitly asked (see root `CLAUDE.md`).
